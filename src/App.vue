      ...
      <div id="botones">
          ...
          >
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div id="totales">
                  <h2>
                    Costo Total:<span style="color: green">{{
                      costo_total()
                    }}</span>
                  </h2>
                  <h2>
                    Precio Total:<span style="color: green">{{
                      PrecioTotal()
                    }}</span>
                  </h2>
                  <h2>
                    Ganacia Total:<span style="color: green">{{
                      ganaciasTotal()
                    }}</span>
                  </h2>
                </div>
        ...
        <p v-if="alerta5" class="error">El campo ganancias dene ser mayor a 0 </p>
                ...
                >
                  ...
                  <div>El campo ganancias debe ser mayor a 0</div>
                </div>
                ...
                <div class="datos">
                  ...
                  >
                    ...
                    <div>Los datos fueron guargados correctamente</div>
                  </div>
                  ...
                  >
                    ...
                    <div>El campo nombre esta vacio</div>
                  </div>
                </div>
                ...
                <div class="datos">
                  ...
                  >
                    ...
                    <div>El campo precio debe ser mayor a 0</div>
                  </div>
                </div>
                ...
                <div class="datos">
                  ...
                  >
                    ...
                    <div>El campo costo debe ser mayor a 0</div>
                  </div>
                </div>
                ...
                <div class="datos">
                  ...
                  >
                    ...
                    <div>El campo cantidad debe ser mayor a 0</div>
                  </div>
                </div>
                ...
                <div class="datos">
                  ...
                  >
                    ...
                    <div>El campo proveedor esta vacio</div>
                  </div>
                </div>
